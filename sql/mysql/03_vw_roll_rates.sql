...
DROP VIEW IF EXISTS fintech_risk.vw_roll_rates;
CREATE VIEW fintech_risk.vw_roll_rates AS
...
WITH loan_buckets AS (
	...
	WHERE TIMESTAMPDIFF(MONTH,l.disbursal_date,r.due_date) BETWEEN 1 AND 18
